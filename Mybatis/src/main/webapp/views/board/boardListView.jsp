...
<html>
  ...
  <body>
    ...
    <div class="outer" align="center">
      ...
      <br />
      <!-- button 태그는 왜 안되지..? ->  form 태그랑 겹치면 안되는거 같음-->
      ...
      <div class="boardBar">
        ...
        <div id="insert-area">
          <c:if test="${loginUser != null}">
            <button
              onclick="location.href='${pageContext.request.contextPath}/insertForm.bo'"
            >
              게시글 등록하기
            </button>
          </c:if>
            ...
            <c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}">
              <c:choose>
                ...
                <c:otherwise>
                  <button
                    class="btn btn-sm btn-primary"
                    onclick="location.href='${pageContext.request.contextPath}/search.bo?cpage=${p}&condition=${condition}&keyword=${keyword}'"
                  >
                    ${p}
                  </button>
                </c:otherwise>
            ...
            <c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}">
              <c:choose>
                ...
                <c:otherwise>
                  <button
                    class="btn btn-sm btn-primary"
                    onclick="location.href='${pageContext.request.contextPath}/list.bo?cpage=${p}'"
                  >
                    ${p}
                  </button>
                </c:otherwise>
